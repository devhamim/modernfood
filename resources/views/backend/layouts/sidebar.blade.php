        ...
        <ul class="sidebar-menu scrollable">
            ...
            <li class="sidebar-item">
                ...
                <ul class="sidebar-link-group">
                    ...
                    <li class="sidebar-dropdown-item">
                        <a href="{{ route('products.index') }}" class="sidebar-link"><span class="nav-icon"><i class="fa-light fa-tag"></i></span> <span class="sidebar-txt">Product</span></a>
                    </li>
                    <li class="sidebar-dropdown-item">
                    ...
                    <li class="sidebar-dropdown-item">
                        <a href="{{ route('videos.index') }}" class="sidebar-link"><span class="nav-icon"><i class="fa-light fa-calendar"></i></span> <span class="sidebar-txt">Video</span></a>
                    </li>
                    ...
                    <li class="sidebar-dropdown-item">
                        <a href="{{ route('medias.index') }}" class="sidebar-link"><span class="nav-icon"><i class="fa-light fa-user-plus"></i></span> <span class="sidebar-txt">Media</span></a>
                    </li>
                    <li class="sidebar-dropdown-item">
